...
namespace AC
{
	...
	public class AdventureCreator : EditorWindow
	{
		...
		public static string version = "1.66.2";
		...
		private void OnGUI ()
		{
			...
			else
			{
				...
				{
					references = CustomAssetUtility.CreateAsset<References> ("References", intendedDirectory);
				}
			}
		...
		public static void RefreshActions ()
		{
			...
			if (!string.IsNullOrEmpty (actionsManager.customFolderPath) && actionsManager.UsingCustomActionsFolder)
			{
				...
				{
					Debug.LogWarning ("Can't access directory " + "Assets/" + actionsManager.customFolderPath + " - does it exist? Exception: " + e);
				}
			}
